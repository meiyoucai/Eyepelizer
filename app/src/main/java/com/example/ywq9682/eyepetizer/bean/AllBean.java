...
public class AllBean {
    ...
    // 我的消息里的的活动通知 与官方通知
    public static final String MESSAGE_URL = "http://baobab.wandoujia.com/api/v3/messages?udid=cd1ee9c5b44e4f9487a505a4fe31ddcb07441cc8&vc=121&vn=2.3.5&deviceModel=" +
            "MI%205&first_channel=eyepetizer_xiaomi_market&last_channel=eyepetizer_xiaomi_market&system_version_code=23";

    ////精选 全部都有(包括里面的内容)
    public static final String SELECTION_URL = "http://baobab.wandoujia.com/api/v2/feed?num=2&udid=cd1ee9c5b44e4f9487a505a4fe31ddcb07441cc8&vc=121&vn=2.3.5&deviceModel" +
            "=MI%205&first_channel=eyepetizer_xiaomi_market&last_channel=eyepetizer_xiaomi_market&system_version_code=23";

    ////搜索的标签 热门搜索词
    public static final String SEARCH_URL = "http://baobab.wandoujia.com/api/v3/queries/hot?udid=cd1ee9c5b44e4f9487a505a4fe31ddcb07441cc8&vc=121&vn=2.3.5&deviceModel=" +
            "MI%205&first_channel=eyepetizer_xiaomi_market&last_channel=eyepetizer_xiaomi_market&system_version_code=23";
    //作者那页的url
    public static final String AUTHOR_URL = "http://baobab.wandoujia.com/api/v3/tabs/pgcs?udid=cd1ee9c5b44e4f9487a505a4fe31ddcb07441cc8&vc=121&vn=2.3.5&deviceModel" +
            "=MI%205&first_channel=eyepetizer_xiaomi_market&last_channel=eyepetizer_xiaomi_market&system_version_code=23";
    public static final String AUTHOR_DETIAL_TIME_URL = "http://baobab.wandoujia.com/api/v3/pgc/videos?pgcId=170&strategy=date&udid" +
